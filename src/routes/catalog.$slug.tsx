...
function ProductPage() {
  ...
  const description = product.description ?? [
    ...
    "Поставляется напрямую от производителя с полным комплектом документации. Подходит для стоматологических клиник и зуботехнических лабораторий на территории РФ.",
