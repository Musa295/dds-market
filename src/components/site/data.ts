...
export const PRODUCTS: Product[] = [
  // ===== Фрезерные станки =====
  {
    ...
    brand: "XTCERA",
    price: "1 500 000 ₽",
    short: "5-осевой фрезерный центр XTCERA X-Mill 500 PRO — обновлённый шпиндель с увеличенным крутящим моментом, магазин 10 фрез, +17% жёсткости конструкции.",
  ...
  },
  {
    ...
    brand: "XTCERA",
    price: "1 150 000 ₽",
    short: "5-осевой фрезерный центр XTCERA X-Mill 500 SE — компактный и интеллектуальный, удалённый мониторинг XMill Monitor.",
    features: ["5 осей", "Сухая обработка", "Шпиндель 60 000 об/мин", "Магазин на 10 фрез"],
  ...
  },
  {
    ...
    brand: "XTCERA",
    price: "1 400 000 ₽",
    short: "5-осевой XTCERA X-Mill 500 Plus для сухой обработки циркония, воска, PMMA и мягких сплавов. Шпиндель 60 000 об/мин, С-холдер.",
    features: ["5 осей", "Автокалибровка", "Шпиндель 60 000 об/мин", "Магазин на 16 фрез"],
  ...
  },
  {
    ...
    brand: "XTCERA",
    price: "2 400 000 ₽",
    short: "5-осевой XTCERA X-Mill 630 для мокрой обработки титана, PMMA, воска и стеклокерамики. Магазин 22 фрезы.",
