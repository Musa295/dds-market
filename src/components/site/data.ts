...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: [
      "Cradle B52SE — улучшенная версия B52 с расширенными возможностями автоматизации и повышенной производительностью. Предназначен для лабораторий с увеличенным потоком заказов и более сложными задачами.",
    ],
  },
