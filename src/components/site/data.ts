...
export const PRODUCTS: Product[] = [
  ...
  // ===== 3D-принтеры по металлу (SLM) =====
  {
    ...
    description: [
      "FastForm DeskFab X1 — компактный стоматологический 3D-принтер для быстрого прототипирования и серийного производства. Используется для печати моделей, хирургических шаблонов, временных конструкций и других изделий с высокой детализацией.",
    ],
  },
