...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: [
      "Srefo E-402 Pro — высокотехнологичная печь для спекания стоматологических материалов с расширенным функционалом.",
      "Преимущества версии PRO над стандартной: расширенные программы спекания, более точная терморегуляция, улучшенная теплоизоляция и увеличенный ресурс работы.",
    ],
    sku: "1329",
  },
  {
  ...
  },
  {
    ...
    description: [
      "Zetin ZTCF-20B PRO — усовершенствованная печь для спекания циркония с высокой точностью.",
      "Преимущества версии PRO: улучшенная теплоизоляция, более точный контроль температуры, расширенные режимы работы и повышенная стабильность процессов по сравнению со стандартной версией.",
    ],
  },
  {
