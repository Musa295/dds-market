...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    features: ["5 осей", "Сухая обработка", "Шпиндель 60 000 об/мин", "Автосмена фрез"],
  ...
  // Циркониевые диски
  {
    ...
    sizes: [
      { label: "98 × 10 мм", price: "5 200 ₽" },
      { label: "98 × 12 мм", price: "5 700 ₽" },
      { label: "98 × 14 мм", price: "6 200 ₽" },
      { label: "98 × 16 мм", price: "6 700 ₽" },
      { label: "98 × 18 мм", price: "7 200 ₽" },
      { label: "98 × 20 мм", price: "7 700 ₽" },
      { label: "98 × 22 мм", price: "8 200 ₽" },
      { label: "98 × 25 мм", price: "9 200 ₽" },
    ],
  },
  {
    ...
    sizes: [
      { label: "98 × 10 мм", price: "7 200 ₽" },
      { label: "98 × 12 мм", price: "7 800 ₽" },
      { label: "98 × 14 мм", price: "8 400 ₽" },
      { label: "98 × 16 мм", price: "9 000 ₽" },
      { label: "98 × 18 мм", price: "9 700 ₽" },
      { label: "98 × 20 мм", price: "10 400 ₽" },
      { label: "98 × 22 мм", price: "11 100 ₽" },
      { label: "98 × 25 мм", price: "12 200 ₽" },
    ],
  },
  {
  ...
  },
  {
    ...
    sizes: [
      { label: "98 × 10 мм", price: "4 000 ₽" },
      { label: "98 × 12 мм", price: "4 400 ₽" },
      { label: "98 × 14 мм", price: "4 800 ₽" },
      { label: "98 × 16 мм", price: "5 200 ₽" },
      { label: "98 × 18 мм", price: "5 600 ₽" },
      { label: "98 × 20 мм", price: "6 000 ₽" },
      { label: "98 × 22 мм", price: "6 400 ₽" },
      { label: "98 × 25 мм", price: "7 200 ₽" },
    ],
  },
  // Титановые диски
  {
  ...
  // Фрезы
  {
    ...
    image: url(burCalib1),
    images: [url(burCalib1), url(burCalib2)],
    sku: "1342",
  },
  {
  ...
  // Дисиликат лития
  {
    ...
    image: url(lithium1),
    images: [url(lithium1), url(lithium2), url(lithium3), url(lithium4)],
  },
  // Металлический порошок (SLM)
  {
