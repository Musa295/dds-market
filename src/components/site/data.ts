...
export const PRODUCTS: Product[] = [
  ...
  // ===== Зуботехническое оборудование и запчасти =====
  {
    ...
    name: "Вытяжная установка Zetin ZT-XCQ-2412",
    category: "Зуботехническое оборудование и запчасти",
    brand: "Zetin",
    price: "62 000 ₽",
    short: "Профессиональная вытяжная установка для зуботехнических лабораторий и CAD/CAM участков. Эффективное удаление пыли циркония, PMMA, гипса и композитов.",
    features: [
  ...
  },
  {
    ...
    name: "Вытяжная установка Zetin ZT-XCQ-2413",
    category: "Зуботехническое оборудование и запчасти",
    brand: "Zetin",
    price: "100 000 ₽",
