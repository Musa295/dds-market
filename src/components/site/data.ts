...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    features: ["5 осей с осью B до ±30°", "Магазин 22 инструмента", "Точность 0,02 мм", "Обработка титана и абатментов"],
    image: url(xtcera630a),
    images: [url(xtcera630a), url(xtcera630b)],
    description: [
      "X-Mill 630 — 5-осевой фрезерный станок для влажной обработки, оснащённый прочной чугунной станиной, автоматической системой смены инструментов и высокопроизводительным шпинделем. Подходит для обработки широкого спектра материалов, включая титан, PMMA, стеклокерамику и абатменты. Идеальное решение для лабораторий и клиник, работающих с имплантатами и мостовидными конструкциями.",
      "Преимущества:",
      "• Интеллектуальное управление: автоматический контроль срока службы инструмента и функция обнаружения повреждений повышают безопасность и качество обработки.",
      "• Пятиосевая обработка: диапазон вращения оси B до ±30° обеспечивает расширенные возможности фрезеровки сложных анатомических форм, включая мосты с опорой на имплантаты.",
      "• Высокоточная конструкция: сервоприводы с винтовыми направляющими и редуктором обеспечивают точность обработки до 0,02 мм и стабильную подачу в трёх линейных осях.",
      "• Автоматическая смена инструмента: магазин на 22 инструмента с автоматическим управлением и функцией контроля износа и повреждения фрез упрощает производственный процесс и снижает вероятность ошибок.",
      "• Поддержка титана и абатментов: станок подходит для обработки титановых абатментов с интерфейсами имплантатов, а также других твёрдых и мягких материалов (PMMA, воск, стеклокерамика).",
    ],
  },
  {
    ...
    features: ["5 осей", "Сухая/мокрая обработка", "Шпиндель 80 000 об/мин", "Автосмена 16 фрез"],
  ...
  },
  {
    ...
    features: ["5 осей", "Автокалибровка", "Сухая обработка", "Автосмена фрез"],
  ...
  },
  {
    ...
    features: ["5 осей", "Сухая обработка", "Шпиндель 60 000 об/мин", "Автосмена 12 фрез"],
  ...
  },
  {
    ...
    features: ["Сухая и мокрая обработка", "Шпиндель 80 000 об/мин", "Водяное охлаждение", "Магазин 12 фрез"],
    image: url(cradleA52dw2),
    images: [url(cradleA52dw2), url(cradleA52dw1)],
    description: [
      "Cradle A52DW — продвинутая модель 5-осевого фрезерного станка для изготовления реставраций высочайшего качества. Наследует лучшие качества модели A52W и предлагает новые возможности, которые делают производственный процесс эффективнее.",
      "Универсальность обработки: станок поддерживает сухую и мокрую обработку — идеален для оксида циркония, стеклокерамики и Ti для индивидуальных абатментов. Воздушное и водяное охлаждение позволяет обрабатывать мягкие материалы без риска перегрева.",
      "Инновационная система: встроенный резервуар для воды с системой фильтров и помпой обеспечивает стабильное качество. Автоматический выбор и смена инструментов (для фрез 0.3–2 мм) делают процесс быстрым и бесперебойным.",
      "Интуитивное управление: 12-дюймовый сенсорный экран и встроенный компьютер позволяют легко настраивать и контролировать процесс фрезеровки независимо от внешних устройств.",
      "Профессиональная точность: обработка <0.01 мм и мощный шпиндель немецкого производства до 80 000 об/мин — от виниров до сложных мостовидных протезов.",
      "Безопасность и надёжность: система продолжает работу даже после экстренного отключения питания, защищая оборудование и минимизируя простои.",
    ],
    specs: [
  ...
  },
  {
    ...
    features: ["4 оси", "Сухая обработка", "Шпиндель 60 000 об/мин", "Компактный корпус"],
  ...
  },
  {
    ...
    features: ["5 осей", "Сухая/мокрая обработка", "Шпиндель 60 000 об/мин", "Автосмена фрез"],
  ...
  },
  {
    ...
    features: ["5 осей", "Автокалибровка", "Сухая/мокрая обработка", "Магазин фрез"],
  ...
  },
  {
    ...
    features: ["До 1200 °C", "Вакуумный насос", "Цветной TFT", "Расширенные программы"],
